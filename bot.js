...
const COMPANY_SHEETS = [
  'ENKIDO TRANSPORTATION LLC', '2I LOGISTICS LLC', 'MUSAFFO CARGO INC',
  'ATN UNITED INC', 'GOLDEN HORSE TRANSPORT LLC', 'GMG EXPRESS LLC',
  'CROSS COUNTRY FREIGHT LINES', 'ALYM TRANS LLC', 'LARCIN EXPRESS LLC',
  'SAFEROAD LLC', 'CHAQQON LOGISTICS LLC', 'IASKK INC', 'XON LOGISTIC LLC',
  'NEWPORT EXPRESS LLC', 'IDNA BUSINESS LLC', 'BEK UZ INC',
  'BURNING SUN LLC', 'LOCHIN EXPRESS LLC', 'MNK LLC',
  'HONOR TRUCK LINES INC', 'MBA GROUP LLC', 'LOYISH EXPRESS LLC',
  'KH SEFIL LOGISTIC INC', 'FASMOVE2 LLC', 'HBC TRADING GROUP INC',
  'L&I EXPRESS LLC', 'JB ORIENTAL EXPRESS INC', 'OTRANS INC',
  'GAMMA CARGO LLC', 'BUFFALO TRUCKING INC',
];
